...
function szamolas() {
        ...
        if(document.getElementById(`kedv1`).checked && document.getElementById(`kedv2`).checked && document.getElementById(`kedv3`).checked){
            ...
            ar=ar*0.9; megtak=math.round(ar*0.1); kedvezmeny=`A törzsvásárlói kedvezmény igénybevételével 10%-os engedményben részesül, ez ${megtak}Ft megtakarítást jelent.`;
        }
        ...
        (`
            <img src="képek/kalktel.png" alt="Óceánjáró télen" class="telkep">
